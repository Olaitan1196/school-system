...
const AdminLoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            login(user, token);
            toast.success(`Welcome back, ${user.first_name || 'Admin'}!`);
            navigate('/admin');
        } catch (error) {
            toast.error(
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-950 via-purple-900 to-purple-800 relative overflow-hidden flex-col justify-between p-12">

                {/* BACKGROUND EFFECTS */}
                <div className="absolute top-0 right-0 w-96 h-96 bg-purple-700/20 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 w-72 h-72 bg-lilac-500/10 rounded-full blur-3xl"></div>
                ...
                <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-purple-300 text-xs">Excellence in Education</p>
                    </div>
                </div>
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-purple-200 text-lg leading-relaxed mb-8">
                        Full control of your school system.
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="admin@comforterscollege.com"
